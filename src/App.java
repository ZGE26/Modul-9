...
public class App {
    ...
    private static cConfig k = new cConfig();
    ...
    public ArrayList<Pelanggan> getPelanggan() throws SQLException {
        ...
        // langkah 4
        while (rs.next()) {
            Pelanggan p = new Pelanggan(rs.getString("id"),
                    rs.getString("nama"), rs.getString("jenis"),
    ...
    public ArrayList<Pelanggan> cariPelanggan(String keyword) throws SQLException {
        ...
        while (rs.next()) {
            ...
            Pelanggan p = new Pelanggan(id, nama, jenis,
